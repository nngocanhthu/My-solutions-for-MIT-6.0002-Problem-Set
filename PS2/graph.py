...
class WeightedEdge(Edge):
    def __init__(self, src, dest, total_distance, outdoor_distance):
        ...
        self.total_dis = total_distance
        self.outdoor_dis = outdoor_distance

    def get_total_distance(self):
        return self.total_dis

    def get_outdoor_distance(self):
        return self.outdoor_dis

    def __str__(self):
        return f'{self.src}->{self.dest} ({self.total_dis}, {self.outdoor_dis})'
...
class Digraph(object):
    ...
    def add_edge(self, edge):
        ...
        if (not (edge.src in self.nodes)) or (not (edge.dest in self.nodes)):
            ...
            if self.edges.get(edge.src) == None:
